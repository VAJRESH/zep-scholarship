...
const StudyBooksForm = () => {
  ...
  return (
    <div className="max-w-xl mx-auto my-10 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="form-group">
            ...
            <div className="relative">
              <select
                ...
                required
                className="block w-full pl-3 pr-10 py-3 text-base border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none"
              >
          ...
          <div className="form-group">
            ...
            <div className="mt-1">
              <textarea
                ...
                rows="5"
                required
                className="shadow-sm block w-full focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-lg p-3"
              ></textarea>
            </div>
