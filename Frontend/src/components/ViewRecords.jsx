      ...
      {records && (
        <Card className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(records.application.status)}`}>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <p className="font-medium text-gray-900 dark:text-white">{records.user.name || "N/A"}</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Email</p>
                <p className="font-medium text-gray-900 dark:text-white">{records.user.email || "N/A"}</p>
              </div>
              {records.studentRegistration && (
                <>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Mother's Name</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Caste</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {records.studentRegistration.caste || "N/A"}
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">College Name</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {records.studentRegistration.collegeName || "N/A"}
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Course Name</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Village Name</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Registration Date</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {formatDate(records.studentRegistration.date)}
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Special Status</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {records.studentRegistration.orphan ? "Orphan" : 
                       records.studentRegistration.disabled ? "Disabled" : "None"}
                    </p>
                  </div>
                </>
              )}
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-sm text-blue-600 dark:text-blue-400 mb-1 font-medium">Generated ID</p>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                <p className="text-sm text-green-600 dark:text-green-400 mb-1 font-medium">Set Number</p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Stream</p>
                <p className="font-medium text-gray-900 dark:text-white">
                  {records.application.stream || "N/A"}
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Medium</p>
                <p className="font-medium text-gray-900 dark:text-white">
                  {records.application.medium || "N/A"}
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Year of Study</p>
                <p className="font-medium text-gray-900 dark:text-white">
                  {records.application.yearOfStudy || "N/A"}
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Field</p>
                <p className="font-medium text-gray-900 dark:text-white">
                  {records.application.field || "N/A"}
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Application Date</p>
                <p className="font-medium text-gray-900 dark:text-white">
        ...
        <Card>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full text-sm font-medium">
              {bookSearchResults.applications.length} result(s)
            </span>
          </div>

          {bookSearchResults.applications.length > 0 ? (
            <div className="space-y-6">
              {bookSearchResults.applications.map((result, index) => (
                <div
                  key={index}
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(result.application.status)}`}>
                      {result.application.status?.toUpperCase() || "PENDING"}
                    </span>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{result.user.email || "N/A"}</p>
                      </div>
                      {result.studentRegistration && (
                        <>
                          <div>
                            <span className="text-gray-500 text-sm">Phone:</span>
                            <p className="font-medium">{result.studentRegistration.phone || "N/A"}</p>
                          </div>
                          <div>
                            <span className="text-gray-500 text-sm">Applicant Name:</span>
                            <p className="font-medium">{result.studentRegistration.applicantName || "N/A"}</p>
                          </div>
                          <div>
                            <span className="text-gray-500 text-sm">College:</span>
                            <p className="font-medium">{result.studentRegistration.collegeName || "N/A"}</p>
                          </div>
                        </>
                      )}
                    </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                        <span className="text-blue-600 dark:text-blue-400 text-sm font-medium">Generated ID:</span>
                        <p className="font-bold text-blue-900 dark:text-blue-300">
                          {result.application.generatedId || "Not assigned"}
                        </p>
                      </div>
                      <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg">
                        <span className="text-green-600 dark:text-green-400 text-sm font-medium">Set Number:</span>
                        <p className="font-bold text-green-900 dark:text-green-300">
                          {result.application.setNumber || "Not assigned"}
                        </p>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                        <span className="text-gray-500 dark:text-gray-400 text-sm">Standard:</span>
                        <p className="font-medium">{result.application.standard || "N/A"}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {result.application.bookNumbers &&
                    Object.keys(result.application.bookNumbers).length > 0 ? (
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {Object.entries(result.application.bookNumbers).map(
                          ([book, number]) => (
                            <div
                              key={book}
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-sm bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                        No books assigned.
                      </p>
                    )}
                  </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-lg font-medium">
                No applications found with book number {bookSearchResults.bookNumber}.
              </p>
              <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">
                Try searching with a different book number or check if the book has been assigned.
              </p>
            </div>
          )}
        </Card>
